...
import { Headphones, Upload, Loader2, FileText, CheckCircle2, ChevronRight, Mic } from "lucide-react";
            ...
            <div className="flex items-center justify-between p-4 bg-[#0d1117] border border-[#30363d] rounded-xl">
              <div className="flex items-center gap-3 overflow-hidden">
                ...
                <div className="truncate">
                  ...
                  <p className="text-[10px] text-[#8b949e]">{(file.size / 1024 / 1024).toFixed(2)} MB</p>
                </div>
              </div>
              <button onClick={() => { setFile(null); setTranscript(null); }} className="text-[#8b949e] hover:text-white transition-colors">
